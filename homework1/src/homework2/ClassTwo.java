...
public class ClassTwo {
    ...
    public static boolean reverse (int d) {
        return  (d <= 0);       //указал условие d <= 0 по аналогии со 2ым пунктом (хотя в задании это не было оговорено), чтобы 0 не остался неприкаянным
    }
